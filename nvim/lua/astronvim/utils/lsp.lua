...
M.setup_diagnostics = function(signs)
  ...
  M.diagnostics = {
    ...
    [0] = extend_tbl(
      default_diagnostics,
      {
        severity_sort = true,
        underline = false,
        virtual_text = false --[[ { prefix = "●", spacing = 2 } ]],
      }
    ...
    -- extend_tbl(
    --   default_diagnostics,
    --   { severity_sort = true, underline = false, virtual_text = false }
    --
    ...
    extend_tbl(
      default_diagnostics,
      { severity_sort = true, underline = true, virtual_text = { prefix = "●", spacing = 2 } }
    ),
  ...
  --         if diagnostic.severity == vim.diagnostic.severity[d:upper()] then return "●" end
  --       end
  --     end,
  --     -- prefix = "●",
